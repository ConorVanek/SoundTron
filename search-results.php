...
$artist = $_GET["artist"] == "" ? "(none)" : $_GET["artist"];
$song =  $_GET["song"] == "" ? "(none)" : $_GET["song"];
...
<div class="row-fluid navmargin">
    ...
    <h1>Search results for artist "<?php echo($artist);?>" and song "<?php echo($song);?>":</h1>
    </div>
</div>
...
<?php
$sql = "SELECT username, title, category, filename FROM songs WHERE username LIKE '%" . $artist . "%' OR title LIKE '%" . $song . "%'";
